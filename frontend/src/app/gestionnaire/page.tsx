        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {cards.map((card) => (
            <Link key={card.label} href={card.href} className="flex flex-col h-full">
              <div className="group h-full rounded-xl border border-border/50 bg-card p-5 hover:border-border/70 hover:shadow-[0_1px_4px_rgba(0,0,0,0.03)] transition-all duration-200 cursor-pointer flex flex-col justify-between">
                <div>
